...
```{r, message = F}
gavglme <- function(TP1, TP2, main = TRUE, where = "", somewhere.else = "", REML = TRUE) {
...
x <- gavglme(75, 125, main = TRUE, "frontal", "prefrontal")

str(x)

sjPlot::tab_model(gavglme(75, 125, main = TRUE, "frontal", "prefrontal"))
sjPlot::tab_model(gavglme(150, 200, main = TRUE, "central", "frontocentral"))
sjPlot::tab_model(gavglme(290, 310, main = TRUE, "central", "centroparietal"))
sjPlot::tab_model(gavglme(575, 625, main = TRUE, "central"))
```
